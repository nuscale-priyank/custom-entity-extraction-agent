...
from managers import EntityCollectionManager, RelationshipDetector
from entity_collection_models import CreateEntityRequest, ReadEntityRequest, DeleteEntityRequest
...
class ConversationalAgent:
    ...
    def __init__(self, project_id: str = None):
        ...
        # Initialize InMemory checkpointer (reliable and fast)
    ...
    def _extract_entities_tool(self, session_id: str, bc3_fields: List[Dict], asset_columns: List[Dict]) -> str:
        ...
        try:
            ...
            from services import SimpleAgent
            agent = SimpleAgent()
